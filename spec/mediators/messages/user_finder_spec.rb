...
RSpec.describe UserFinder, ".from_message" do
...
RSpec.describe UserUserFinder, "#call" do
  before do
...
RSpec.describe AppUserFinder, "#call" do
  before do
    @id = SecureRandom.uuid
...
RSpec.describe EmailUserFinder, "#call" do
  before do
    @id = SecureRandom.uuid
